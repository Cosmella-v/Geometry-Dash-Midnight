...
namespace GameObjectsFactory {
    ...
    public:
        ...
        std::function<bool(PlayerObject*)> m_hasbeenActivated = nullptr;
        ...
        bool m_hasbeenActivatedBypass = false; // override that it has been activated without a og call
...
auto func(auto par = ((GameObjectConfig*)nullptr)->mem) { mem = par; return this; }
        ...
        ___582923_param_set_func_GameObjectsFactory(SetHasBeenActivatedBypass, m_hasbeenActivatedBypass);
...
auto func(auto par = def) { mem = par; return this; }
        ...
        ___582923_callback_set_func_GameObjectsFactory(HasbeenActivatedByPlayer,[](void*) -> bool { return true; }, m_hasbeenActivated);
